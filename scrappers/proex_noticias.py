...
def proex_noticias(old_articles, old_page_hash):
    msg = "Nova notícia publicada pela PROEX"
    site = "proex_noticias"
    main_url = 'https://www.proex.ufop.br'
    ...
    while True:
        try:
            request = requests.get(f'https://www.proex.ufop.br/noticias?page={page}')
